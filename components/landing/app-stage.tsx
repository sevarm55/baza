 ...
 *
 * Дорожка четыре высоты экрана, а не семь тысяч точек, как в примере.
 * Там это герой целой страницы и ему отдана вся прокрутка; у нас секций
 * восемь. Число одно и меняется в одном месте.
 *
...
export function AppStage({
  ...
  return (
    <div ref={track} className="relative h-[400svh]">
