  ...
  landing: {
    ...
    sections: {
      ...
      expenses: {
        ...
        body: 'Аренда, вода, химия. Разовый расход ложится в свой день, постоянный делится по дням месяца. Чистый результат пересчитывается сразу.',
      },
      reports: {
        label: 'Отчёты',
        title: 'Аналитика, а не один график',
        body: 'Выручка, зарплаты, расходы и чистый результат за любой период. Загрузка по часам, средний чек, услуги, команда и сравнение с прошлым периодом.',
      },
      branches: {
        label: 'Филиалы',
