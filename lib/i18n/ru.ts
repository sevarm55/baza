...
export const ru: Dict = {
  ...
  landing: {
    nav: {
      ...
      homeAria: 'Tetrin, главная страница',
      footerAria: 'Правовые документы и поддержка',
    ...
    hero: {
      eyebrow: 'Учёт для бизнеса',
      title: 'Каждая машина записана.',
      lead: 'Машины, деньги, сотрудники и расходы в одном месте.',
      cta: 'Начать бесплатно',
      secondary: 'Посмотреть, как это работает',
      note: (days: number) => `${days} ${pl(days, 'день', 'дня', 'дней')} бесплатно · без карты`,
    },

    demo: {
      business: 'Автомойка «Алик»',
      point: 'Центр',
      demoBadge: 'ДЕМО',
      live: 'сейчас',
      ...
      services: ['Комплекс', 'Кузов', 'Салон'],
      crew: ['Арман', 'Гор', 'Айк'],
      payments: ['Наличные', 'Карта', 'Перевод'],
      categories: ['Аренда', 'Химия', 'Электричество', 'Вода'],

      newUnit: 'Новая машина',
      plate: 'Номер',
      ...
      taps: 'Три касания на телефоне мойщика',

      units: 'Машины',
      avgCheck: 'Средний чек',
      onShift: 'на смене',
      flow: 'Ход дня',
      lastUnits: 'Последние машины',
      perHour: 'в час',

      team: 'Команда',
      autoPayroll: 'Зарплата считается сама',
      rate: 'ставка',
      brought: 'принёс',
      activity: 'Ход смены',
      feedAdded: (plate: string) => `добавил ${plate}`,
      feedOpened: 'открыл смену',

      newCost: 'Добавить расход',
      category: 'Категория',
      amount: 'Сумма',
      comment: 'Комментарий',
      commentPlaceholder: 'Август',
      addCost: 'Добавить расход',
      costsToday: 'Расходы за сегодня',
      netBecomes: 'Чистая прибыль становится',
    ...
    beats: [
      {
        label: 'Регистрация',
        title: 'Учёт ведёт тот, кто работает.',
        body: 'Номер, услуга, оплата. Мойщик записывает сам, потому что там же видит свой заработок.',
      },
      {
        label: 'День',
        title: 'День виден сейчас.',
        body: 'Машины, касса и команда обновляются по мере работы. Вечером вспоминать нечего.',
      },
      {
        label: 'Команда',
        title: 'Зарплата без калькулятора.',
        body: 'У каждой записи есть имя, процент считается сам. Ни одного спора в конце месяца.',
      },
      {
        label: 'Расходы',
        title: 'Расходы не теряются.',
        body: 'Вода, химия, электричество. После записи чистая прибыль пересчитывается сразу.',
      },
      {
        label: 'Итог',
        title: 'В конце остаётся одна цифра.',
        body: 'День, неделя, месяц считаются одинаково. Выручка минус зарплаты и расходы.',
      },
    ],
    ...
    price: {
      title: 'Всё это',
      per: 'в месяц',
      point: 'за один филиал',
      trial: (days: number) => `${days} ${pl(days, 'день', 'дня', 'дней')} бесплатно`,
      note: 'Один продукт, одна цена. Карта не нужна.',
    },

    closing: {
      title: 'День закончился.',
      titleAccent: 'Цифры уже готовы.',
      note: (days: number) => `${days} ${pl(days, 'день', 'дня', 'дней')} бесплатно`,
    },

    footer: 'Учёт для сервисного бизнеса',
  },
  ...
  reports: {
    ...
    charts: {
      dynamics: 'Динамика',
      dynamicsNote: 'Выручка, зарплаты, расходы и чистый результат',
      series: { revenue: 'Выручка', payroll: 'Зарплаты', costs: 'Расходы', net: 'Чистыми', prev: 'Предыдущий' },
      cars: 'Машины',
