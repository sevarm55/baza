...
export const ru: Dict = {
  ...
  landing: {
    ...
    heroAlt: 'Мокрая графитовая машина и работник в тёмном боксе автомойки',
    heroLine1: 'КАЖДАЯ МАШИНА',
    heroLine2: 'ЗАПИСАНА.',

    railAria: 'Главные числа за сегодня',
    carsWord: (n: number) => pl(n, 'машина', 'машины', 'машин'),
    revenueWord: 'выручка',
    netWord: 'чистыми',
    ...
    tapService: 'Услуга',
    tapPayment: 'Оплата',
    tapsAlt: 'Струя воды под давлением на машине и телефон в руке работника',
    tapsDone: 'Записано',

    todayLabel: '02 / СЕГОДНЯ',
    todayLine1: 'ВСЁ',
    todayLine2: 'НА ВИДУ.',
    todayAlt: 'Двое работников моют машины в тёмном боксе автомойки',

    moneyLabel: '03 / ДЕНЬ В ЧИСЛАХ',
    moneyRevenue: 'Выручка',
    moneyWages: 'зарплаты',
    moneyCosts: 'расходы',
    moneyLeft: 'Вам остаётся:',

    teamLabel: '04 / КОМАНДА',
    teamLine1: 'СЧИТАТЬ',
    teamLine2: 'НЕ НАДО.',
    teamNote: 'Зарплата считается сама.',
    teamAria: 'Рассчитанные зарплаты работников',
    teamAlt: 'Работник автомойки у мокрой машины смотрит в телефон',
    teamNames: ['Арман', 'Гор', 'Айк'],

    closingLabel: '05 / ЯСНЫЙ ИТОГ',
    closingLine1: 'ДЕНЬ',
    closingLine2: 'ЯСЕН.',
    closingNote: 'Машины, деньги и команда — в одном месте.',
    closingAlt: 'Чистая графитовая машина выезжает с мойки на свет',

    priceIntro: 'ПРОСТАЯ ЦЕНА',
    pricePeriod: 'в месяц',
    pricePerPoint: 'за один филиал',

    footerTag: 'Учёт для автомоек',
    footerNavAria: 'Правовые документы и поддержка',
  },
