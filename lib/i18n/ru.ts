...
export const ru: Dict = {
  ...
  landing: {
    ...
    sections: {
      ...
      expenses: {
        ...
        body: 'Аренда, вода, химия. Разовый расход ложится в свой день, постоянный делится по дням месяца. Сумма, которая вам остаётся, пересчитывается сразу.',
      },
      reports: {
        label: 'Отчёты',
        title: 'Аналитика, а не один график',
        body: 'Выручка, зарплаты, расходы и то, что вам остаётся, за любой период. Загрузка по часам, средний чек, услуги, команда и сравнение с прошлым периодом.',
      },
      branches: {
        label: 'Филиалы',
  ...
  reports: {
    ...
    charts: {
      dynamics: 'Динамика',
      dynamicsNote: 'Выручка, зарплаты, расходы и то, что вам остаётся',
      series: { revenue: 'Выручка', payroll: 'Зарплаты', costs: 'Расходы', net: 'Остаётся', prev: 'Предыдущий' },
      cars: 'Машины',
