...
export const ru: Dict = {
  ...
  auth: {
    ...
    rememberedExpired: 'Срок сохранённого входа истёк. Введите номер и ПИН.',
    wrongCredentials: 'Неверный номер или ПИН',
    ...
    tempAccessTitle: 'Ваш ПИН временный',
    tempAccessNote: (deadline: string) => `Он перестанет работать ${deadline}. Задайте свой ПИН.`,
    tempAccessAction: 'Задать свой ПИН',
    ...
    staffAccessCodeNote: 'Сотрудник будет входить по своему номеру телефона и этому ПИНу.',
  },
  ...
  firstRun: {
    ...
    s3Note: 'Работник входит по своему номеру и ПИНу, открывает смену и записывает вымытые машины.',
  ...
  profile: {
    ...
    account: 'Аккаунт',
    phone: 'Телефон',
    pinNote: 'Позволяет входить без SMS. Этот ПИН также используется для быстрого входа в аккаунт.',
    access: 'Подписка',
  ...
  settings: {
    ...
    staffNote:
      'Сотрудник входит со своего телефона и с ПИНом. Продиктуйте ему ПИН, пароль запоминать не нужно.',
    removeStaffNote:
    ...
    pinReset: 'Выдать новый ПИН',

    pinResetNote: 'Сотрудник забыл ПИН. Назначьте новый, входы старым закроются.',

    pinResetDone: 'ПИН изменён. Передайте его сотруднику.',

    pinWorksElsewhere: 'Этот человек работает не только здесь. ПИН он меняет сам, из своего профиля.',
