 ...
 * вчера.
 *
 * Считаем по взятой цене: скидка со счёта разносится по строкам
 * пропорционально, и столбец складывается в выручку периода. Подробно
 * о том, почему не по прайсу, — в `getServiceBreakdown`.
 */
