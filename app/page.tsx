    ...
    <div className={s.page}>
      ...
      <main id="main">
        {/* Рабочий день. Дальше вся страница — один рабочий день, и
            ...
            по мере чтения текста слева. На телефоне витрина собрана как
            витрина: обещание первым кадром, дальше продукт — в рамке
            телефона. Живой прибор во всю ширину экрана читался не
            рассказом о системе, а самой системой, будто человек уже
            внутри; рамка возвращает масштаб — вот приложение, которое
            ты получишь.
      ...
      {/* Кнопка внизу телефонного экрана. Появляется после того, как
          продукт показали в рамке, — продукт уже показали, и теперь есть
          о чём просить, — и уходит, как только рассказ кончился: ниже
          цена со своей кнопкой. Двух одинаковых кнопок в одном кадре на
