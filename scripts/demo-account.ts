...
const OWNER_PHONE = '+37400000000';
const STAFF_PHONE = '+37400000001';
const OWNER_PIN = '2468';
const STAFF_PIN = '1357';

/* Код оператора 00 в Армении не существует и выдан быть не может.
   Обычный красивый номер вроде 99 000 000 однажды достанется живому
   человеку, и тот упрётся в «номер занят», не понимая почему. */
