...
struct ReportHeatmap: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            /* Прокрутка обрезается по своим краям. Без обрезки клетки
               выезжали за карточку и висели на полотне: приём годился,
               пока карта лежала на голом листе, а внутри бумаги он
               читается поломкой. */
        }
    }
